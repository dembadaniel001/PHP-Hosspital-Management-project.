...
session_start();
   ...
   if(isset($_POST['deleteButton'])){
	   ...
	   $sql = "delete from appointments_booked where appointment_id =". $_SESSION['delete_id'].";";
...
<body style="background-color:#d3e4f8;">
    ...
    <div class="container">
        ...
        <ol class="breadcrumb" style="background-color:#f1655c;">
            ...
            <li class="breadcrumb-item"><a href="#"><span>Booked Appointments.</span></a></li>
        </ol>
        <div class="card">
            <div class="card-header" style="background-color:rgba(181,24,109,0.59);">
                <h5 class="mb-0" style="font-family:Times new roman;font-size:20px;"><strong>Appoints Booked</strong></h5>
            </div>
            <div class="card-body" style="background-color:#d3e4f8;">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover table-dark table-sm">
                        <caption>Patient Appointments.</caption>
                        <thead>
                            <tr>
                                <th style="color:rgb(254,254,254);"><strong>Sno</strong></th>
                                <th style="color:rgb(254,254,254);"><strong>Patient id</strong></th>
                                <th style="color:rgb(254,254,254);"><strong>Patient Nmae</strong></th>
                                <th style="color:rgb(254,254,254);"><strong>Doc Name&nbsp;</strong></th>
                                <th style="color:rgb(254,254,254);"><strong>Hopital</strong></th>
                                <th style="color:rgb(254,254,254);"><strong>Date and time</strong></th>
                                <th style="color:rgb(254,254,254);"><strong>ACTIONS </strong>.</th>
                            </tr>
                        </thead>
                        <tbody>
                            <!-- this is the place where the row insertion will take place.-->
							<?php
							   $viewAppointments = new viewAppointments();
                               $viewAppointments->getAppointments();
							?>
                        </tbody>
                        <tfoot>
                            <tr>
                                <td>SNO<br></td>
                                <td>PATIENT ID<br></td>
                                <td>PATIENT NMAE<br></td>
                                <td>DOC NAME&nbsp;<br></td>
                                <td>HOPITAL<br></td>
                                <td>DATE AND TIME<br></td>
                                <td>ACTIONS&nbsp;<br></td>
                            </tr>
                        </tfoot>
                    </table>
...
<div role="dialog" tabindex="-1" class="modal fade" id="deleteModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color:#fee1e1;">
            ...
            <div class="modal-body">
                <p style="color:rgb(0,0,0); text-align:center;">Are you sure you want to delete the appointment made by the particular patiet ??</p>
                <form action="viewAppointments.php?delete_id=$_SESSION['delete_id']" method = "post">
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-2 offset-5"><button class="btn btn-danger " type="submit" style="color:rgb(255,255,255);background-color:rgb(255,74,85);" name = "deleteButton" ><i class="fa fa-thumbs-up"></i><strong>YES</strong></button></div>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer" style="background-color:#fee1e1;"><button class="btn btn-primary" type="button" data-dismiss="modal" style="color:rgb(246,246,246);background-color:rgb(52,114,247);">Close</button></div>
        </div>
    </div>
</div>
<div role="dialog" tabindex="-1" class="modal fade" id="successfulDeletion">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color:#cbffd3;">
            ...
            <div class="modal-body">
                <p style="color:rgb(0,0,0);">The appointment has successfully been deleted.</p>
            </div>
            <div class="modal-footer" style="background-color:#cbffd3;"><button class="btn btn-primary" type="button" data-dismiss="modal" style="color:rgb(249,249,249);background-color:rgb(52,114,247);">Close</button></div>
        </div>
    </div>
</div>
