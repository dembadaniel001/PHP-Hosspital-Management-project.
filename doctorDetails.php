<?php 
	 ...
	 $sql = "select Fname, Lname,SurName, Date_Of_Birth, phone_number, email, Residence, Specialisation from doctor_details where doc_id =".$_SESSION['doc_id'].";";	 
	 $valid = $databaseObject->conn->query($sql);
	 if($valid){
		 echo "query good.";
...
<body style="background-color:#d3e4f8;">
    <div class="container" style="margin-top:130px;"><div class="row">
    <div class="col">
        ...
        <ol class="breadcrumb" style="background-color:#f1655c;">
            ...
            <li class="breadcrumb-item"><a href="docDash.php"><span>Doctor DashBoard</span></a></li>
            <li class="breadcrumb-item"><a href="doctorDetails.php"><span>Doctor Details</span></a></li>
        </ol>
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text">Second Name:</span></div><input class="form-control" type="text" name="lName" value="<?php echo $Lname ;?>" required="" style="font-size:20px;font-family:times new roman;">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text">Sur Name:</span></div><input class="form-control" type="text" name="sName" value="<?php echo $SurName ;?>"  required="" style="font-size:20px;">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text">D.O.B</span></div><input class="form-control" type="date" name="dob" value="<?php echo $Date_Of_Birth;?>" required="" style="font-size:20px;">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text">Phone No :</span></div><input class="form-control" type="text" name="phoneNo" value="<?php echo $phone_number;?>"  required="" inputmode="tel" style="font-size:20px;">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text">Email Add :</span></div><input class="form-control" type="text" name="emailAdd" value="<?php echo $email;?>"  inputmode="email" style="font-size:20px;">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text">Residence :</span></div><input class="form-control" type="text" name="reidence" value="<?php echo $Residence;?>"  style="font-size:20px;">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text">Specialisation :</span></div><input class="form-control" type="text" name="specialisation" value="<?php echo $Specialisation;?>" style="font-size:20px;color:rgb(0,0,0);">
                                    <div class="input-group-append"></div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-5 offset-4">
                                    <div class="btn-group btn-group-lg" role="group"><button class="btn btn-success btn-block" name = "updateDetails" type="submit" style="color:rgb(255,255,255);background-color:rgb(135,203,22);">Update</button><button class="btn btn-warning" type="reset" style="color:rgb(255,255,255);background-color:rgb(255,149,0);">Reset&nbsp;</button></div>
                                </div>
                            </div>
                            </form>
                        </div>
	...
	<div role="dialog" tabindex="-1" class="modal fade" id="dataUpdate">
