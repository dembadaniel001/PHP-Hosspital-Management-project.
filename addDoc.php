                        ...
                        <div class="row">
                            ...
                            <div class="form-row">
                                <div class="col-5 offset-4">
                                    <div class="btn-group btn-group-lg" role="group"><button class="btn btn-success btn-block" name = "updateDetails" type="submit" style="color:rgb(255,255,255);background-color:rgb(135,203,22);">ADD.</button><button class="btn btn-warning" type="reset" style="color:rgb(255,255,255);background-color:rgb(255,149,0);">Reset&nbsp;</button></div>
                                </div>
                            </div>
                            </form>
                        </div>
